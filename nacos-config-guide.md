...
spring:
  ...
  datasource:
    ...
    url: jdbc:mysql://192.168.1.103:3306/ruoyi-flex?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true
    username: root
...
spring:
  ...
  datasource:
    driver-class-name: com.mysql.cj.jdbc.Driver
    url: jdbc:mysql://192.168.1.103:3306/ruoyi-flex?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=Asia/Shanghai&allowPublicKeyRetrieval=true
    username: root
    password: mysql654321
    type: com.alibaba.druid.pool.DruidDataSource
    druid:
